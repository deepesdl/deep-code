...
class TemplateGenerator:
    ...
    def generate_dataset_template(output_path: str | None = None) -> str:
        ...
        optional = {
            ...
            "coord_position": "[OPTIONAL: Position of the coordinates within each grid cell. 'center' assumes coordinates represent cell centers, 'left' assumes they represent the left/top edge, and 'right' assumes they represent the right/bottom edge.]",
            "cf_parameter": [
